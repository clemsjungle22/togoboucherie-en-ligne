...
<main role="main">
    ...
    <section class="py-5 text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Commandez  votre <br> Viande préférée </h1>
...
{{--                {{dump($produits)}}         --}}
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 400px;">
                         <img src="{{ asset('sel/produits/' . $produit->photo_principale) }}" class="card-img-top img-fluid" alt="Responsive image" style="width:100%; height: 70%;">
                        <div class="card-body">
                            <p class="card-text">{{$produit->nom}} <br>{{$produit->description}}</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="/box" class="btn btn-danger">Acheter</a>
                                <a href="{{route('voir_produit_mer', ['id'=>$produit->id])}}" class="btn btn-sm btn-outline-secondary"><i class="fas fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div> 
