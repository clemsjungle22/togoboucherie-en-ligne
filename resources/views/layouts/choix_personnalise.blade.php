      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card border-primary">
          <div class="card-body text-black">
            ...
            <strong><p class="card-text" style="color: red">15.000 FCFA</p></strong> 
            ...
            <div class="form-check">
              <a href="/produit_personnalise" class="btn btn-danger">Choisir</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card border-primary">
          <div class="card-body text-black">
            ...
            <strong><p class="card-text" style="color: red">29.500 FCFA</p></strong> 
            ...
            <div class="form-check">
              <a href="/produit_personnalise_grosse" class="btn btn-danger">Choisir</a>
            </div>
          </div>
        </div>
      </div>
